...
if(isset($update))
{
mysqli_query($conn,"update notice set subject='$sub',Description='$details',Date=now() where notice_id='".$_GET['notice_id']."'");
$err="<font color='blue'>Notice updated </font>";
header("Location: http://localhost/online_notice_board/admin/index.php?page=display_notice");
